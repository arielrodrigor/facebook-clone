...
import { ChatBubbleBottomCenterIcon, ShareIcon, HandThumbUpIcon } from "@heroicons/react/24/outline";
function Post({name, message, email, timestamp, image, postImage} ) {
    return (
        <div className={'flex flex-col'}>
            <div className={'p-5 bg-white mt-5 rounded-t-2xl shadow-sm'}>
                <div className={'flex items-center space-x-2'}>
                    <Image className={'rounded-full'} src={image} width={40} height={40} layout={'fixed'} alt={''}/>
                    <div>
